...
import ScopeList from './pages/base/ScopeList';
...
import ProjectFollowList from './pages/project/FollowList';
import ProjectManagement from './pages/project/ProjectManagement';
import ProjectTemplate from './pages/project/ProjectTemplate';

// inquery price
import PriceList from './pages/mall/Inquiry/Price/PriceList';
import ShopPrice from './pages/mall/Inquiry/Price/ShopPrice';
import PriceDetail from './pages/mall/Inquiry/Price/PriceDetail';
...
const routerConfig = [
  ...
  {
    path: '/project/followList/:unionId',
    name: 'ProjectFollowList',
    layout: Blank,
    component: ProjectFollowList,
    meta: {
      title: '项目进度列表'
    }
  },
  {
    path: '/project/ProjectManagement/:unionId',
  ...
  {
    path: '/project/ProjectTemplate/:unionId',
  ...
  {
    path: '/mall/Inquiry/Price/PriceList/:siteId',
    name: 'PriceList',
    layout: Blank,
    component: PriceList,
    meta: {
  ...
  {
    path: '/mall/Inquiry/Price/ShopPrice/:siteId',
    name: 'ShopPrice',
    layout: Blank,
    component: ShopPrice,
    meta: {
  ...
  {
    path: '/mall/Inquiry/Price/PriceDetail/:siteId',
    name: 'PriceDetail',
    layout: Blank,
