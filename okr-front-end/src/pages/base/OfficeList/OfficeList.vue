<template>
  <div>
          ...
          <el-table-column
            ...
            <template slot-scope="props">
              <div class="office-card">
                ...
                <div class="desc">{{props.row.address?props.row.address:'' + props.row.addr?props.row.addr:''}}</div>
              </div>
            </template>
          </el-table-column>
          <el-table-column
    ...
    <office-edit ref="editDialog"  @open-scope-list="openScopeList" @ok="handleUpdateSuccess" :siteOptions="siteOptions"></office-edit>
    <scope-list v-show="isShowScopeList" ref="scopeList"　 @ok="handleUpdateScopeList"　></scope-list>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    name: "OfficeList",
    components: {StatisticalDataPanel, OfficeEdit, OfficeDetail,ScopeList},
    mixins: [
      listMixin
    ],
    data() {
    ...
    methods: {
      ...
      //打开所属范围页面
      openScopeList(vo){
        this.isShowScopeList = true;
        this.$refs.scopeList.open(vo);
      },
      handleUpdateSuccess() {
        this.$refs.tableMain.fetchData();
        this.refreshOfficeStaticData();
      },
      handleUpdateScopeList(){
        this.isShowScopeList = false;
