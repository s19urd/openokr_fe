...
export default {
   ...
   * @returns {*}
   */
  degradeDevice (systemSiteRelId) {
    return axios.get('/energy/ecaSystemSiteRel/batchPushDownUnitAndDeviceRelation.json', {
        params: {
            systemSiteRelId
        }
    })
   ...
   * @returns {*}
   */
  degradeUser (siteId,outSysId,systemName) {
    return axios.get('/energy/ecaSystemSiteRel/batchPushDownUserAndUnitRelation.json', {
        params: {
            siteId,
            outSysId,
            systemName
